 ...
 * it is created.
 */
public abstract class BasicMergeManager implements MergeManager {
    //PRIVATE FIELDS//
     ...
     */
    public BasicMergeManager(MergeConnection merge, double currentTime, Registry<MergeManager> mmRegistry){
        this.merge = merge;
